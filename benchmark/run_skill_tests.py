...
#
# FRAMEWORK_DIR (scaffold/, Dockerfile, build/) is SEPARATE and always anchored to
...
DOCKER_SH = FRAMEWORK_DIR / "scaffold" / "shell" / "docker.sh"
...
def run_all(subset: str = None, task_id: str = None, count: int = 2, workers: int = 4, use_judge: bool = False):
    ...
    dockerfile_dir = FRAMEWORK_DIR / "tasks" / "skill-eval" / "environment"

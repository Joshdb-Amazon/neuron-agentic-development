...
| [ tensor_copy_dynamic_src ](generated/nki.isa.tensor_copy_dynamic_src.md#nki.isa.tensor_copy_dynamic_src) | Create a copy of src tile within NeuronCore on-chip SRAMs using Vector or Scalar or GpSimd Engine, with src located at a dynamic offset within each partition. |
| [ tensor_copy_dynamic_dst ](generated/nki.isa.tensor_copy_dynamic_dst.md#nki.isa.tensor_copy_dynamic_dst) | Create a copy of src tile within NeuronCore on-chip SRAMs using Vector or Scalar or GpSimd Engine, with dst located at a dynamic offset within each partition. |
...
| [ register_move ](generated/nki.isa.register_move.md#nki.isa.register_move) | Move a compile-time constant integer value into a virtual register. |
...
| [ sendrecv ](generated/nki.isa.sendrecv.md#nki.isa.sendrecv) | Perform point-to-point communication between NeuronCores by sending and receiving data simultaneously using DMA engines. |

# Matmul + Subtract + Multiply + ReLU — Optimization

You are optimizing the `matmul_subtract_multiply_relu` kernel through 5 versioned improvements.

- **Baseline kernel**: `evals/neuron-nki-agent/examples/matmul_subtract_multiply_relu/output/matmul_subtract_multiply_relu_kernel.py`
- **Baseline test**: `evals/neuron-nki-agent/examples/matmul_subtract_multiply_relu/output/test_matmul_subtract_multiply_relu.py`
- **Working directory**: `evals/neuron-nki-agent/examples/matmul_subtract_multiply_relu/optimization/tmp/`
- **Final output**: `evals/neuron-nki-agent/examples/matmul_subtract_multiply_relu/optimization/output/`
...
You are assigned neuron cores **16–19** (4 cores).
Set `NEURON_RT_VISIBLE_CORES=16-19` in every compile and run command.
...
3. **Design the optimization** — consult `/neuron-nki-optimizing` for strategies that
   ...
   patterns.
4. **Implement** as `matmul_subtract_multiply_relu_v<N>.py` in the working directory.
...
Only write to `evals/neuron-nki-agent/examples/matmul_subtract_multiply_relu/optimization/output/` when completely done:
...
- `matmul_subtract_multiply_relu_v5.py` — your best optimized kernel (or latest working version)
- `test_matmul_subtract_multiply_relu.py` — correctness test covering baseline and optimized
...
- `NEURON_RT_VISIBLE_CORES=16-19` on every compile/run
- Use `evals/neuron-nki-agent/examples/matmul_subtract_multiply_relu/optimization/tmp/` for ALL intermediate work
- Only write final deliverables to `evals/neuron-nki-agent/examples/matmul_subtract_multiply_relu/optimization/output/`
- Do NOT modify the original kernel or test files in `evals/neuron-nki-agent/examples/matmul_subtract_multiply_relu/output/`

# Conv2D + Scale + Min — Optimization

You are optimizing the `conv2d_scaling_min` kernel through 5 versioned improvements.

- **Baseline kernel**: `evals/neuron-nki-agent/examples/conv2d_scaling_min/output/conv2d_scale_min_kernel.py`
- **Baseline test**: `evals/neuron-nki-agent/examples/conv2d_scaling_min/output/test_conv2d_scale_min.py`
- **Working directory**: `evals/neuron-nki-agent/examples/conv2d_scaling_min/optimization/tmp/`
- **Final output**: `evals/neuron-nki-agent/examples/conv2d_scaling_min/optimization/output/`
...
You are assigned neuron cores **0–3** (4 cores).
Set `NEURON_RT_VISIBLE_CORES=0-3` in every compile and run command.
...
3. **Design the optimization** — consult `/neuron-nki-optimizing` for strategies that
   ...
   patterns.
4. **Implement** as `conv2d_scale_min_v<N>.py` in the working directory.
...
Only write to `evals/neuron-nki-agent/examples/conv2d_scaling_min/optimization/output/` when completely done:
...
- `conv2d_scale_min_v5.py` — your best optimized kernel (or latest working version)
- `test_conv2d_scale_min.py` — correctness test covering baseline and optimized
...
- `NEURON_RT_VISIBLE_CORES=0-3` on every compile/run
- Use `evals/neuron-nki-agent/examples/conv2d_scaling_min/optimization/tmp/` for ALL intermediate work
- Only write final deliverables to `evals/neuron-nki-agent/examples/conv2d_scaling_min/optimization/output/`
- Do NOT modify the original kernel or test files in `evals/neuron-nki-agent/examples/conv2d_scaling_min/output/`
